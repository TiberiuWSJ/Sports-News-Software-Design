<template>
    <nav class="navbar">
      <div class="menu">
        <router-link to="/journalist/stories" class="nav-link">Manage Stories</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      performSearch() {
        this.$router.push({ name: 'stories', query: { q: this.searchQuery } });
      }
    }
  };
  </script>
